...
<header class ="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-loght sidebar collapse">
                <div class="position-sticky md-3">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="table-responsive">
                    <form action="editUsers.php" method="POST">
                        ...
                        <br>
                        <button class="w-100 btn btn-lg btn-ptimary" type="submit" name="submit">Change</button>
                    </form>
                </div>
            </main>
        </div>
